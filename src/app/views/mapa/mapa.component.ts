...
export class MapaComponent implements OnInit, OnDestroy,AfterViewInit  {
  ...
  //ELEMENTO PARA BUSCAR DIRECCIONES
  //************ */
  //VARIABLES PARA LOS MARCADORES DE LOS PUNTOS
  ...
  listadoPuntos: any[] = [];
  verticesPoligono = [];
  //VARIBLES PARA LOS MARCADORES DE LOS PUNTOS
  posiciones: Posicion[] = [];
  ...
  //MÉTODO PARA INGRESAR LOS PUNTOS DE LA ZONA SEGURA
  IngresarPuntos() {
  ...
  //MÉTODO PARA CREAR EL POLÍGONO DE LA ZONA SEGURA
  crearPoligono() {
